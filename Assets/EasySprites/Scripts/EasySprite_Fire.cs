...
public class EasySprite_Fire : MonoBehaviour {
	...
	void Start () 
	{
		...
		renderer.sharedMaterial.SetFloat("_OffsetX", _Offset);
		renderer.sharedMaterial.SetFloat("_DistanceX", _Distance);
		renderer.sharedMaterial.SetFloat("_WaveTimeX", _WaveTime);
